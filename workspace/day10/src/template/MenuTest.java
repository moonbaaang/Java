...
//			FileWriter fw = null;
			...
			if(menu == 1) {
				...
				try {
				FileWriter fw = new FileWriter("employee.txt", true); // false일 경우 덮어쓰기됨. true로 설정한다.
				fw.write(e.toString()+"\n");
				fw.close();
				} catch(IOException ex) {ex.printStackTrace();}
				
/* day9 /employee.txt파일에 e객체의 id, name, salary 3 변수내용을 1줄에 출력
*/
				
/* day9/employee.txt파일 저장, employee 객체만큼 입력
