...
/*
JAVA API를 사용하여 다음과 같은 결과가 나오도록 빈칸을 채우십시오. 단, 빈칸은 반드시 적절한 메쏘드를 
사용해서 채워져야 합니다.
...
class StringTest {
	...
	System.out.println("구분갯수 = "+details.length);
	for(int i =0;i<details.length;i++) {
		System.out.println(details[i]);
	}
	
	//StringTokenizer클래스 >> 문자열 분할 기능 전용
	StringTokenizer st = new StringTokenizer
			("서울시/강남구-역삼동:100번지 위워크빌딩 5층", "/-:");
